...
# Load dictionaries
dict_non_ext_copular_fname = "dictionaries/dict-not-ext-copular.txt"
...
dict_ext_copular_fname = "dictionaries/dict-ext-copular.txt"
...
dict_copular_fname = "dictionaries/dict-copular.txt"
with open(dict_copular_fname) as f:
    dict_copular = [s.strip() for s in f.readlines() if len(s.strip()) > 0 and s.lstrip()[0] != '#']    


dict_complex_transitive_fname = "dictionaries/dict-complex-transitive.txt"
...
dict_ignore_fname = "dictionaries/dict-adverbs-ignore.txt"
